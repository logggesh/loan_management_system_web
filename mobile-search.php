        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-5 text-center">
                ...
                <div class="col-lg-12 mt-5 d-flex justify-content-center">
                        <input class="form-control" type="text" placeholder="Please Enter The Mobile Number" name="mob_sc">
                        ...
                        <table class="table">
                            <thead class="thead-dark">
                                ...
                                <?php
                                    ...
                                    $query = "select loan, customername, phonenumber, vechiclename, modelyear, registrationnumber FROM loandetails WHERE phonenumber='$mob_sc'";
