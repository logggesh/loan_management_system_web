...
<head>
    ...
    <link rel="stylesheet" href="delete-loan-search.css">
</head>
<body>
            ...
            <div class="col-lg-9 main-page">
                ...
                <form method="POST">
                    <div class="col-lg-12 mt-5 d-flex justify-content-center">
                        <input class="form-control" type="text" placeholder="Please Enter The Loan Number" name="loan_number">
                        ...
                        <table class="table">
                            <thead class="thead-dark">
                                ...
                                <?php
                                    ...
                                    $query="select loan,customername,phonenumber,vechiclename,modelyear,registrationnumber from loandetails where loan=$loannumber";
