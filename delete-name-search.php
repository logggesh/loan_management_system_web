...
<head>
    ...
    <link rel="stylesheet" href="delete-name-search.css">
</head>
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 main-page">
                ...
                <div class="col-lg-12 mt-5 d-flex justify-content-center">
                        <input class="form-control" type="text" placeholder="Please Enter The Name" name="cus_name">
                        ...
                        <table class="table">
                            <thead class="thead-dark">
                                ...
                                <?php
                                    ...
                                    $password="";
                                    $dbname="loandetails";
                                    $name_1=$_POST['cus_name'];
                                    $con=mysqli_connect($hostname,$username,$password,$dbname);
                                    $query = "select loan, customername, phonenumber, vechiclename, modelyear, registrationnumber FROM loandetails WHERE customername='$name_1'";
