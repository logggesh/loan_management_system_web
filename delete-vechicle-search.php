...
<head>
    ...
    <link rel="stylesheet" href="delete-vechicle-search.css">
</head>
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 main-page">
                <div class="col-lg-12 h4 text-center mt-5">
                    Delete With Registration Number
                </div>
                ...
                <form method="POST">
                    <div class="col-lg-12 mt-5 d-flex justify-content-center">
                        <input class="form-control" type="text" placeholder="Please Enter The Vechicle Number" name="reg_no">
                        ...
                        <table class="table">
                            <thead class="thead-dark">
                                ...
                                <?php
                                    ...
                                    $query="select loan,customername,phonenumber,vechiclename,modelyear,registrationnumber from loandetails where registrationnumber='$reg_no'";
