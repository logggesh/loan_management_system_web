...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="list-group">
                            ...
                            <a href="loan-view.php" class="list-group-item list-group-item-action active">View</a>
  ...
  <tbody>
        ...
        echo "<td><a href='delete-row.php?loan=$loannumber' class='btn btn-danger' action='loan-view.php' id='del_but_conf'>Delete</a></td>";
        echo "</tr>";
        }
        ?>
  </tbody>
